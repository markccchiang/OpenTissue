...
BOOST_AUTO_TEST_SUITE(opentissue_math_big_lu);
...
BOOST_AUTO_TEST_CASE(logic_and_valid_arguments_testing)
{
  ...
  matrix_type invA;
  {
    matrix_type A;
    vector_type x,b;
    BOOST_CHECK_THROW( OpenTissue::math::big::lu(A,x,b), std::invalid_argument );
    BOOST_CHECK_THROW( OpenTissue::math::big::lu_invert(A,invA), std::invalid_argument );
  }
  {
    matrix_type A;
    vector_type x,b;
  ...
  }
  {
    ...
    BOOST_CHECK_NO_THROW( OpenTissue::math::big::lu(A,x,b) );
    BOOST_CHECK_NO_THROW( OpenTissue::math::big::lu_invert(A,invA) );
  }
  {
    matrix_type A;
    vector_type x,b;
