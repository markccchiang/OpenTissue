...
BOOST_AUTO_TEST_SUITE(opentissue_geometry_util_compute_inscribed_radius_length_quality_measure);
  ...
  BOOST_AUTO_TEST_CASE(case_by_case_testing)
  {
...

    {
      ...
      real_type quality = OpenTissue::geometry::compute_inscribed_radius_length_quality_measure(p0,p1,p2,p3);
      std::cout << quality << std::endl;

      BOOST_CHECK_CLOSE( quality, 0.907169, tol);
    }
    {
      // close to flat
      vector3_type p0(-1,-1, 0);
      ...
      real_type quality = OpenTissue::geometry::compute_inscribed_radius_length_quality_measure(p0,p1,p2,p3);
      std::cout << quality << std::endl;
      BOOST_CHECK_CLOSE( quality, 0.010953629716851243, tol);
    }
    {
