#ifndef OPENTISSUE_CORE_GEOMETRY_GEOMETRY_COMPUTE_OBB_SHELL_H
#define OPENTISSUE_CORE_GEOMETRY_GEOMETRY_COMPUTE_OBB_SHELL_H
//
...
//OPENTISSUE_CORE_GEOMETRY_GEOMETRY_COMPUTE_OBB_SHELL_H
#endif
