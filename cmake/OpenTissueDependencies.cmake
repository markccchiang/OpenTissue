...
if(TARGET OpenGL::GL AND TARGET GLEW::GLEW AND TARGET glfw AND TARGET GLUT::GLUT)
  ...
  # Target names contain "::", so a ":" separated pair splits in the wrong place and reports
  # every entry as missing. Walk two parallel lists instead.
  set(_ot_gfx_targets OpenGL::GL GLEW::GLEW glfw GLUT::GLUT)
  set(_ot_gfx_labels  OpenGL     GLEW       GLFW GLUT)
  set(_ot_missing_gfx "")
  list(LENGTH _ot_gfx_targets _ot_gfx_count)
  math(EXPR _ot_gfx_last "${_ot_gfx_count} - 1")
  foreach(_i RANGE ${_ot_gfx_last})
    list(GET _ot_gfx_targets ${_i} _tgt)
    list(GET _ot_gfx_labels  ${_i} _label)
    if(NOT TARGET ${_tgt})
